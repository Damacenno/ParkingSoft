...
CREATE TABLE IF NOT EXISTS `registros` (
  ...
  `entrada_auto` bigint(20) DEFAULT NULL,
  `saida_auto` bigint(20) DEFAULT NULL,
...
-- Copiando dados para a tabela parkingsoft.registros: ~6 rows (aproximadamente)
...
INSERT INTO `registros` (`id_registro`, `categoria`, `placa_auto`, `modelo_auto`, `vaga_auto`, `data_ocorrencia_auto`, `entrada_auto`, `saida_auto`, `status_pago_auto`, `id_estacionamento`) VALUES
	(92, 'Moto', '123ABC', 'Eclipse', 2, NULL, 1709226928801, NULL, 1, 1),
	(93, 'Carro', 'LKJ566', 'Eclipse', 2, NULL, 1709226935346, NULL, 0, 1),
	(94, 'Carro', 'VUC871', 'Jaguar', 3, NULL, 1709226940794, NULL, 0, 1),
	(98, 'Moto', 'JEA456', 'Marea', 4, NULL, 1709292315583, NULL, 0, 1),
	(99, 'Moto', 'ABC123', 'Kwid', 6, NULL, 1709558226728, NULL, 0, 1),
	(100, 'Carro', 'MUE973', 'Kwid', 1, NULL, 1709745020694, NULL, 0, 1);
...
INSERT INTO `usuarios` (`id_estac`, `nome_estac`, `cnpj_estac`, `login_estac`, `senha_estac`, `total_vagas_carro_estac`, `total_vagas_moto_estac`, `status_pago_estac`) VALUES
	(1, 'Joao Estacionamentos', '11111111000111', 'admin', '$2y$10$Zn9VYWg3BnbeOb9OcbDhxuE4gA0yXFErtWNr0p1YI95BzOYatWKcC', 7, 15, NULL);
