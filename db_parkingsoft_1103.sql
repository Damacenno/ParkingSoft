...
CREATE TABLE IF NOT EXISTS `usuarios` (
  ...
  `total_vagas_carro_estac` int(11) unsigned zerofill NOT NULL,
...
INSERT INTO `usuarios` (`id_estac`, `nome_estac`, `cnpj_estac`, `login_estac`, `senha_estac`, `endereco_estac`, `numero_contato_estac`, `email_estac`, `total_vagas_carro_estac`, `total_vagas_moto_estac`, `status_pago_estac`) VALUES
	(1, 'Joao Estacionamentos', '11111111000111', 'admin', '$2y$10$Zn9VYWg3BnbeOb9OcbDhxuE4gA0yXFErtWNr0p1YI95BzOYatWKcC', 'Rua do Ka Sete', 1169696969, 'estacionei@gmail.com', 00000000005, 10, 0);
