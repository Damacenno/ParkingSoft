...
-- Copiando dados para a tabela parkingsoft.carros: ~0 rows (aproximadamente)
DELETE FROM `carros`;
...
INSERT INTO `usuarios` (`id_estac`, `nome_estac`, `cnpj_estac`, `login_estac`, `senha_estac`, `total_vagas_estac`, `status_pago_estac`) VALUES
	(1, 'Joao Estacionamentos', '11111111000111', 'admin', '$2y$10$Zn9VYWg3BnbeOb9OcbDhxuE4gA0yXFErtWNr0p1YI95BzOYatWKcC', 6, NULL);
